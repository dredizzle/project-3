  ...
  db.dropDatabase()
    ...
    .then(users => {
      ...
      },
      {
        ...
        description: "In the spring of 2017, Adam Shoalts, bestselling author and adventurer, set off on an unprecedented solo journey across North Americas greatest wilderness. A place where, in our increasingly interconnected, digital world, it's still possible to wander for",
        createdBy: emma
