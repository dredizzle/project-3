...
mongoose.connect(
  dbURI, { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true }, (err, db) => {
    db.dropDatabase()
      .then(() => {
        return User.create([{
          username: "seangray1",
      ...
      .then(() => {
        return User.create([{
          username: "seagray1",
          email: "sean.myles.ray@gmail.com",
          password: "pass",
          passwordConfirmation: "pass",
          image: "https://i.imgur.com/aFoCicH.jpg"
        }, {
          username: "gaelton",
          email: "gabelton@gbles.com",
          password: "pass",
          passwordConfirmation: "pass",
          image: "https://i.imgur.com/aFoCicH.jpg"
        }, {
          username: "erice",
          email: "ekprice01@gmil.com",
          password: "pass",
          passwordConfirmation: "pass",
          image: "https://s1.r29static.com//bin/entry/9d4/x,80/2164076/taylor-swift-cant-stop-teasing-2164076.jpg"
        }])
      ...
      .finally(() => mongoose.connection.close()) // disconnect from the database
